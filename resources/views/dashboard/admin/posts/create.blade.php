...
<div class="row">
    <div class="col-lg-12 mx-auto">
        <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>Create News</div>
            <div class="card-body">
                <form class="color-form" method="POST" action="{{route('posts.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="excerpt" class="form-control " maxlength="150" required >
                        </div>
                         <div class="form-group col-md-12">
                            <label for="input-13">Meta Keyword (SEO)</label>
                            <input type="text" name="meta_keyword" class="form-control " maxlength="150" required >
                        </div>
                        <div class="form-group col-md-12">
                            <label for="input-13">Meta Description (SEO)</label>
                            <input type="text" name="meta_description" class="form-control " maxlength="150" required >
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="content" id="summernoteEditor" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <br><br>
