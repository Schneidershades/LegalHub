...
<!-- Mirrored from demo.dueza.com/tribunal-html/tribunal/gold-color/single-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Aug 2019 22:50:39 GMT -->
<head>
    <!-- META -->
    <meta charset="utf-8">
    ...
    <!-- PAGE TITLE -->
    <title>TRIBUNAL &#8211; Lawyer, Law Firm and Legal Attorney Template</title>
    <!-- FAVI ICON -->
                            ...
                            <div class="navbar navbar-nobg">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        <li><a class="smoth-scroll" href="#home">Home <div class="ripple-wrapper"></div></a>
                                        </li>
                                        ...
                                        <li class="active"><a class="smoth-scroll" href="#blog">blog</a>
                                        </li>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="single-blog-details wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s" data-wow-offset="0">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla. Maecenas sit amet ligula est. Fusce fringilla sollicitudin enim in varius. Praesent nisi neque, condimentum sit amet lacus inLorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla. Maecenas sit amet ligula est. Fusce fringilla sollicitudin enim in varius. Praesent nisi neque, condimentum sit amet lacus inLorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla.</p>  
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla. Maecenas sit amet ligula est. Fusce fringilla sollicitudin enim in varius. Praesent nisi neque, condimentum sit amet lacus inLorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla. Maecenas sit amet ligula est. Fusce fringilla sollicitudin enim in varius.</p>
                    ...
                    <div class="comment-section wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s" data-wow-offset="0">
                        ...
                        <div class="single-comment">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h6 class="text-muted"><i class="fa fa-calendar"></i> 15 May 2017 | 24 hour ago</h6>
                        ...
                        <div class="single-comment">
                            <div class="media">
                                <div class="col-md-3 text-center">
                                    ...
                                    <h6 class="text-muted text-center">Sharon</h6>
                                </div>
                                <div class="col-md-9">
                                    <h6 class="text-muted"><i class="fa fa-calendar"></i> 14 May 2017 | 30 minuites ago</h6>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sed augue nulla. Maecenas sit amet ligula est. Fusce fringilla sollicitudin enim in varius. Praesent nisi neque, condimentum sit amet lacus in.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="contact-form">
                        <div class="row">
                            <form action="http://demo.dueza.com/tribunal-html/tribunal/gold-color/assets/php/contact.php" method="post">
                ...
                <div class="col-md-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s" data-wow-offset="0">
                    ...
                    <div class="recent-post single-sidebar">
                        ...
                        <div class="recent-single">
                            ...
                            <span><h6 class="text-muted"><i class="fa fa-user-secret"></i> Admin.  <i class="fa fa-calendar"></i> 15 May 2017. <i class="fa fa-comment"></i> 3.</h6></span>
                        </div>
                        <div class="recent-single">
                            <a href="#"><img src="assets/images/blog/blog2.jpg" class="img-responsive" alt="image">
                            </a>
                            <a href="#"><h4>Blog Title Here</h4></a>
                            <span><h6 class="text-muted"><i class="fa fa-user-secret"></i> Admin.  <i class="fa fa-calendar"></i> 14 May 2017. <i class="fa fa-comment"></i> 5.</h6></span>
                        </div>
                    </div>
                    <div class="categories single-sidebar">
                        ...
                        <ul>
                            <li><a href="#"><i class="fa fa-hand-o-right"></i> Capital Market</a>
                            </li>
                            <li><a href="#"><i class="fa fa-hand-o-right"></i> Personal Injury</a>
                            </li>
                            <li><a href="#"><i class="fa fa-hand-o-right"></i> Education Law</a>
                            </li>
                            <li><a href="#"><i class="fa fa-hand-o-right"></i> Family Law</a>
                            </li>
                            <li><a href="#"><i class="fa fa-hand-o-right"></i> Bank & Financial</a>
                            </li>
                            <li><a href="#"><i class="fa fa-hand-o-right"></i> Corporate Law</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <div class="footer-text">
                        <h6>&copy;copyright | TRIBUNAL 2017.Developed by DuezaThemes</h6>
                    </div>
