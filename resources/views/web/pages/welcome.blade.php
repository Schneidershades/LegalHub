            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="form-group mb-30">
                        ...
                        <input type="text" class="form-control" id="fullname" placeholder="Your Email">
                    </div>
                </div>
                <div class="col-sm-6 col-md-6">
                    <div class="form-group">
                        <label for="message">Message Us</label>
                        <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Type Your Message"></textarea>
                    </div>
                </div>
                <div class="col-md-12">
